...
ALTER TABLE ORDER_PRODUCT_MAPPING
ADD CONSTRAINT FOREIGN KEY (PRODUCT_ID) REFERENCES PRODUCT_INFO(PRODUCT_ID);

ALTER TABLE SALES_FACT
ADD CONSTRAINT FOREIGN KEY (CUSTOMER_ID) REFERENCES CUSTOMER_INFO(CUSTOMER_ID);

ALTER TABLE SALES_FACT
ADD CONSTRAINT FOREIGN KEY (store_id) REFERENCES BRANCH_DETAILS(store_id);
...
-- Loading data into BRANCH_DETAILS-- INSERTING RECORDS INTO BRANCH_DETAILS
...
-- Loading data into ORDER_PRODUCT_MAPPING-- INSERTING RECORDS INTO ORDER_PRODUCT_MAPPING

INSERT INTO ORDER_PRODUCT_MAPPING VALUES
(1000,'7713',6),
(1001,'3690',3),
(1001,'4925',8),
(1001,'7713',5),
...
SELECT COUNT(*) AS TOTAL FROM ORDER_PRODUCT_MAPPING;

SELECT *  FROM ORDER_PRODUCT_MAPPING;
#_____________________________________________________________________________________
-- Loading data into SALES_FACT-- INSERTING RECORDS INTO SALES_FACT
...
SELECT COUNT(*) AS TOTAL FROM SALES_FACT;

#_____________________________________________________________________________

------------- # 1. Number of Transactions by Gender a] Transactions by Men b]Transactions by Women
...
----------------------#2. Number of Customers Who Have Placed an Order from More Than One Store
...
----------------------#4. Area with Highest Sales (Sum of All Sales Prices)
SELECT b.city,b.area, SUM(p.SALE_PRICE * op.QUANTITY_ORDERED) AS total_sales
FROM SALES_FACT s
...
SELECT b.state, COUNT(DISTINCT s.CUSTOMER_ID) AS total_customers
FROM SALES_FACT s
JOIN BRANCH_DETAILS b ON s.STORE_ID = b.STORE_ID
GROUP BY b.state
...
----------------#Creating Conditional Columns To segment customers into loyalty tiers based on purchase frequency:
SELECT CUSTOMER_ID,
       CASE 
